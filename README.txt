...
a. The data used in this analysis is available on OSF at: . It contains the data needed to generate all results and figures. Download and copy the data files to
a folder in the working directory named "data".
