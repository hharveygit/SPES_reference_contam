%% Function to simulate an evoked potential as part of the code to test CARLA
%
% Copied from the original CARLA manuscript. If this code is used in a publication, please cite the manuscript:
%
%    "CARLA: Adjusted common average referencing for cortico-cortical evoked potential data"
%    by H Huang, G Ojeda Valencia, NM Gregg, GM Osman, MN Montoya, GA Worrell, KJ Miller, and D Hermes.
%    Journal of Neuroscience Methods, 407, 110153.
%
%    Copyright (C) 2023 Harvey Huang
%    Included here as functions/genRandSig.m
%
...
function sig = genRandSig(tt, nChs, amp)
    ...
    %tau2 = 0.05 + rand(nChs, 1)*0.06; % time constant to dampen the slower sinusoid (s2)
