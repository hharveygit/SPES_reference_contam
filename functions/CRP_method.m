...
%
% This function performs canonical response parameterization and is part of the original CRP manuscript package;
% it is copied here for convenience as part of the SPES reference selection and re-referencing package.
%
...
%    by K.J. Miller, K.R. Müller, G.O. Valencia, H. Huang, N.M. Gregg, G.A. Worrell, & D. Hermes (2023).
%    PLoS computational biology, 19(5), e1011105.
%
%    Copyright (C) 2022 Kai J Miller
%    Revised 2023 at time of manuscript re-submission (kjm)
%    Included here as functions/CRP_method.m
%
